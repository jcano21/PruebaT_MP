...
INSERT INTO Fiscalia (nombre, ubicacion) 
VALUES ('Fiscalía 1', 'Zona 1');

INSERT INTO EstadoCaso (nombre_estado)
VALUES ('Pendiente'), ('En Progreso'), ('Cerrado');

INSERT INTO Usuario (nombre_usuario, contrasena, rol, email)
VALUES ('juanperez', 'encripted_password_123', 'Fiscal', 'juan.perez@mp.gob.gt'),
       ('mariagomez', 'encripted_password_456', 'Fiscal', 'maria.gomez@mp.gob.gt');

INSERT INTO Fiscal (nombre, id_fiscalia, id_usuario)
VALUES ('Juan Pérez', 1, 1),
       ('María Gómez', 1, 2);

INSERT INTO Caso (descripcion, fecha_creacion, id_fiscal, id_estado, id_fiscalia)
VALUES ('Caso de prueba', GETDATE(), NULL, 1, 1);
GO